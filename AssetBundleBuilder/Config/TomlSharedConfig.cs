...
public class TomlSharedConfig {
    ...
    [TomlProperty("texture_types")] public Dictionary<string, TextureTypeConfig> TextureTypes { get; set; } = [];
}

public class TextureTypeConfig {
    [TomlProperty("patterns")] public List<string> Patterns { get; set; } = [];
}
