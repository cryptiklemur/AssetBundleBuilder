...
public static class UnityPathFinder {
    ...
    public static List<string> GetUnitySearchPaths() {
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows)) {
            ...
            if (!string.IsNullOrEmpty(userProfile)) paths.Add(Path.Combine(userProfile, "Unity", "Hub", "Editor"));
        }
            ...
            if (!string.IsNullOrEmpty(home)) paths.Add(Path.Combine(home, "Applications", "Unity", "Hub", "Editor"));
        }
